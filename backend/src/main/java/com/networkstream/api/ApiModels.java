...
public final class ApiModels {
    ...
    public record Hotspot(String id, String name, String providerName, double latitude, double longitude,
    ...
    public record GatewayRegistrationRequest(String gatewayId, String hotspotId, String version,
                                             String hostname, String platform) {}
    public record GatewayHeartbeatRequest(String gatewayId, String version, String status, String hostname) {}

    public record GatewayPolicy(String gatewayId, long version, List<ClientPolicy> clients) {}
    public record ClientPolicy(String sessionId, String userId, String plan, String status,
                               int downloadMbps, int uploadMbps, long quotaBytes, long usedBytes) {}

    public record UsageReport(String gatewayId, List<ClientUsage> clients) {}
